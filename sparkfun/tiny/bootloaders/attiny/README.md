...
This version of micronucleus has been copied and modified by SparkFun Electronics for the Roshamglo project. The original micronucleus can be found at https://github.com/micronucleus/micronucleus.
...
Output file is "main.hex," which should be uploaded to your microcontroller using a program like avrdude. It can also be copied to the /releases folder.
...
t84_roshamglo   -   ATtiny84A for Roshamglo project     -   1586 bytes
