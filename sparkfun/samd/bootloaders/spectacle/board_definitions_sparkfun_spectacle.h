...
#define CRYSTALLESS // The Spectacle does not have an external 32kHz oscillator
/*
 * USB device definitions
 */
#define STRING_PRODUCT "SparkFun Spectacle Director"
#define USB_VID_HIGH   0x1B
#define USB_VID_LOW    0x4F
#define USB_PID_HIGH   0x88
#define USB_PID_LOW    0x88
